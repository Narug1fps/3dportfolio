                            ...
                            <div className="lg:col-span-5 space-y-8">
                                <div className="bg-gray-50 p-10 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-12">
                                    <div className="space-y-6">
                                        <h3 className="text-3xl font-bold text-black">Informações Básicas</h3>
                                    ...
                                    <div className="space-y-8">
                                        <div className="flex items-center gap-6 group">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-lg font-bold text-black">vitor@photo.com</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-center gap-6 group">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-lg font-bold text-black">(62) 99999-9999</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-center gap-6 group">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-lg font-bold text-black">Goiânia, GO - Brasil</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="bg-white p-10 md:p-14 rounded-[3rem] border border-gray-100 shadow-2xl relative overflow-hidden">
                                    ...
                                    <div className="relative z-10 space-y-12">
                                        <div className="space-y-4">
                                            <h3 className="text-4xl font-bold text-black">Mande sua Proposta</h3>
                                        ...
                                        <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                                <div className="space-y-3">
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full px-8 py-5 bg-gray-50 border border-transparent focus:border-[#0091FF] focus:bg-white rounded-2xl outline-none transition-all duration-300 font-bold text-black"
                                                    />
                                                </div>
                                                <div className="space-y-3">
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <div className="relative">
                                                    <select className="w-full px-8 py-5 bg-gray-50 border border-transparent focus:border-[#0091FF] focus:bg-white rounded-2xl outline-none transition-all duration-300 font-bold text-black appearance-none cursor-pointer">
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <textarea
                                                    ...
                                                    className="w-full px-8 py-6 bg-gray-50 border border-transparent focus:border-[#0091FF] focus:bg-white rounded-2xl outline-none transition-all duration-300 font-bold text-black resize-none"
                                                ></textarea>
                                            </div>
